...
- buddy check next week deadline.
...
- live language switch + 4th language implemented.
- Merlijn fixed some bugs and UI. He didn't reach the lines of codes but
- Filip added a meaningful addition for searching + tests
- Seymur added a meaningful addition for searching + tests
